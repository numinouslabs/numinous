...
from neurons.validator.models.numinous_client import GetEventsResponse, NuminousEvent
...
class TestPullEventsTask:
    ...
    def pull_events_task(self, db_client: DatabaseClient, bt_wallet: Wallet):
        ...
        api_client = NuminousClient(env="test", logger=logger, bt_wallet=bt_wallet)
    ...
    def test_parse_event(self, db_operations_mock, api_client_mock):
        ...
        # Arrange
        event = NuminousEvent.model_validate(
            {
                "event_id": "123",
                "title": "Test Event?",

...
alias gateway_api="python -m uvicorn neurons.miner.gateway.app:app --reload --host 0.0.0.0 --port 8000 2>&1 | tee gateway.log"
alias upload_agent="python neurons/miner/scripts/upload_agent.py"
